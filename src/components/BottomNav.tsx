...
const BottomNav = () => {
  ...
  return (
    <div className="w-full my-0 mx-auto rounded-2xl bg-[#012237] flex items-center justify-between p2">
      {navItems.map((item) => (
        <div
        key={item.title}
      ...
      >
        <item.icon cssClasses={item.active ? "!text-[#fdb224]" : "!fill-[#fdb224]"}/>
